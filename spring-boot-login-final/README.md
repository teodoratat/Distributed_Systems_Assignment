...
# App Properties
com.bezkoder.spring.login.bezkoder.app.jwtCookieName= com.bezkoder.spring.login.bezkoder
com.bezkoder.spring.login.bezkoder.app.jwtSecret= ======================BezKoder=Spring===========================
com.bezkoder.spring.login.bezkoder.app.jwtExpirationMs= 86400000
```
- For MySQL
```
